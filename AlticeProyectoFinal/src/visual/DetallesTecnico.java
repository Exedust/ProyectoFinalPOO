...
public class DetallesTecnico extends JDialog {
    ...
    public DetallesTecnico(Empleado emp) {
...

        {
            ...
            JLabel label = new JLabel("Solicitudes Completadas: 00");
            label.setForeground(Color.WHITE);
            label.setFont(new Font("Segoe UI", Font.PLAIN, 13));
            label.setBounds(12, 42, 175, 16);
            panel_1.add(label);
            
            JLabel label_1 = new JLabel("Solicitudes Tomadas: 00");
            label_1.setForeground(Color.WHITE);
            label_1.setFont(new Font("Segoe UI", Font.PLAIN, 13));
            label_1.setBounds(12, 13, 175, 16);
            panel_1.add(label_1);
            
            JLabel label_2 = new JLabel("Solicitudes Canceladas: 00");
            label_2.setForeground(Color.WHITE);
            label_2.setFont(new Font("Segoe UI", Font.PLAIN, 13));
            label_2.setBounds(12, 71, 175, 16);
            panel_1.add(label_2);

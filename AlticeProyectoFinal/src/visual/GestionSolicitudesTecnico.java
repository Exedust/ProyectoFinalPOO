...
public class GestionSolicitudesTecnico extends JDialog {
    ...
    public static void main(String[] args) {
        try {
            GestionSolicitudesTecnico dialog = new GestionSolicitudesTecnico();
     ...
     * Create the dialog.
     */
    public GestionSolicitudesTecnico() {
        ...
        {
            JButton btnNewButton_3 = new JButton("Tomar Solicitud");
            ...
            btnNewButton_3.setBounds(1137, 145, 114, 25);
        ...
        }
        {
        	...
        	btnVerDetalles.setBounds(1134, 616, 117, 25);
        	contentPanel.add(btnVerDetalles);
        }
        {
        	JButton btnDejarSolicitud = new JButton("Dejar Solicitud");
        	btnDejarSolicitud.setForeground(Color.WHITE);
        	btnDejarSolicitud.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        	btnDejarSolicitud.setFocusPainted(false);
        	btnDejarSolicitud.setBorder(new LineBorder(new Color(150, 150, 220), 1, true));
        	btnDejarSolicitud.setBackground(new Color(0, 0, 51));
        	btnDejarSolicitud.setBounds(1137, 183, 114, 25);
        	contentPanel.add(btnDejarSolicitud);
        }
        {
        	...
        	btnCompletar.setBounds(1137, 578, 114, 25);
